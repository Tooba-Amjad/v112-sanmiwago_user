...
class User {
  ...
  User({
    ...
    this.appId = "",
    this.userId = "",
    this.referralLinkBaseurl = "",
    this.shareLinkBaseurl = "",
  });
  ...
  User copyWith({
    ...
    String? shareLinkBaseurl,
      ...
      User(
        ...
        referralLinkBaseurl: referralLinkBaseurl ?? this.referralLinkBaseurl,
        shareLinkBaseurl: shareLinkBaseurl ?? this.shareLinkBaseurl,
      );
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        userId: json["user_id"] ?? "",
        // userId: json["id"] ?? "",
        referralLinkBaseurl: json.containsKey("referal-link-baseurl") ? json["referal-link-baseurl"] ?? "" : "",
        shareLinkBaseurl: json.containsKey("share-link-baseurl") ? json["share-link-baseurl"] ?? "" : "",
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "app_id": appId,
        "user_id": userId,
        "referal-link-baseurl": referralLinkBaseurl,
        "share-link-baseurl": shareLinkBaseurl,
      };
}
