...
String _format(String value, String seperator, TextEditingValue old) {
  ...
  dev.log('----> splitArrOLD: $splitArrOLD');
  dev.log('----> splitArrNEW: $splitArrNEW');
  for (var i = 0; i < 3; i++) {
  ...
  if ((splitArrOLD[0].isNotEmpty &&
    ...
    dev.log('blocked finalString : $finalString ');
  } else {
    if (splitArrNEW[0].length > splitArrOLD[0].length) {
      ...
      dev.log('splitArrNEW[0].length == 2');
      ...
      dev.log('splitArrNEW[0].length < splitArrOLD[0].length');
    ...
    dev.log('finalString after yyyy=> $finalString');
  }
