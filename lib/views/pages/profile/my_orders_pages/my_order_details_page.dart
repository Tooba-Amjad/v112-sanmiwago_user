  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        color: Colors.white,
        child: Obx(() {
          return myOrdersController.selectedOrderData.value.orderItems.isNotEmpty && !apiController.isLoadingMyOrderDetails.value
              ? ListView(
                  ...
                  children: [
                    ...
                    Obx(() {
                      return myOrdersController.selectedOrderData.value.order.isPointsRedeemed.toLowerCase() != "yes" &&
                              (double.tryParse(myOrdersController.selectedOrderData.value.order.staffTip) ?? 0.0) != 0.0
                          ? Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                const MyText(
                    ...
                    myOrdersController.selectedOrderData.value.order.orderType.toLowerCase() == "delivery" &&
                            (double.tryParse(myOrdersController.selectedOrderData.value.order.doordashDriverTip) ?? 0.0) != 0.0
                        ? Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const MyText(
                              ...
                              Obx(() {
                                return MyText(
                                  text: (myOrdersController.selectedOrderData.value.order.paymentType).toLowerCase() == "stripe" ||
                                      ...
                                      : getPaymentTypeText(
                                          myOrdersController.selectedOrderData.value.order.paymentType,
                                          myOrdersController.selectedOrderData.value.order.planType,
                                        ),
                                      ...
                                      children: [
                                        ...
                                        Obx(() {
                                          return MyText(
                                            ...
                                            // text: (myOrdersController.selectedOrderData.value.order.refundDateTime).capitalizeItsFirst(),
                                            color: AppColors.kBlackColor,
                                            fontSize: 16,
                                            paddingTop: 0,
                                            fontWeight: FontWeight.w600,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Obx(() {
                                    return MyText(
                                      text: myOrdersController.selectedOrderData.value.order.isPointsRedeemed.toLowerCase() != "yes"
                                          ? "-\$${((double.tryParse(myOrdersController.selectedOrderData.value.order.refundAmount) ?? 0) - ((double.tryParse(myOrdersController.selectedOrderData.value.order.refundStaffTip) ?? 0) + (double.tryParse(myOrdersController.selectedOrderData.value.order.refundTax) ?? 0.0))).toPrecision(2).toStringAsFixed(2)}"
                                          // ? "\$${myOrdersController.selectedOrderData.value.order.totalCost}"
                                          : "-\$0.00",
                                      color: AppColors.kBlackColor,
                                      fontSize: 16,
