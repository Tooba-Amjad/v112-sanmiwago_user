...
class SubscriptionOrderRejectedMissedPage extends StatelessWidget {
  final String orderId;
  final String invoiceNumber;
  final String offerId;
  final String offerRestaurantId;

  const SubscriptionOrderRejectedMissedPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        ...
        subscriptionsController.clearOrderData();
        navigate(
                ...
                children: [
                  ...
                  const MyText(
                    text: "We are extremely sorry. We cannot serve your order at this time. "
                        "You payment method have not been charged yet. We look forward to serving "
                        "you in the future!",
                    color: AppColors.kWhiteColor,
                    align: TextAlign.center,
                    fontSize: 18,
            ...
            Expanded(
              child: Container(
                ...
                child: MyButton(
                  ...
                  onPressed: () async {
                    if (!isRejected) {
                      if (!apiController.isBuyingItemsFromSubscriptionOffer.value) {
                        subscriptionsController.placeSubscriptionOfferItemsOrder(offerId: offerId, offerRestaurantId: offerRestaurantId);
                      }
                    } else {
